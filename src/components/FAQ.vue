<template>
    <section class="p-3 p-lg-5 d-flex justify-content-center align-items-center linear-bg" :style="{ height: '100vh' }" id="faq">
        <div class="row">
            <div class="col-12 col-lg-6 p-4">
                <h1 class="fw-bold">FREQUENTLY ASKED <br />QUESTIONS</h1>
                <p class="fs-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                    incididunt ut labore et dolore magna aliqua.</p>
                <button class="btn btn-primary fs-5">Asked Question</button>
            </div>
